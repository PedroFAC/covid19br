...
const CountriesPanel = () => {
    ...
    const colunas = [
        {
            title: 'País', field: 'country', render: rowData => {
    ...
    const emptyColumns = [
        { title: 'País', field: 'state', render: rowData => <Skeleton /> },
            ...
            <Paper elevation={3}>
                {loaded ? (
                    <Tabela data={data} columns={colunas} title="Países Afetados" />
                        ...
                        <Tabela data={emptyState()} columns={emptyColumns} title="Países Afetados" />
                    )
                }
            </Paper>
        </div>
